...
public class KacamataPreskripsi extends Kacamata{
	...
	public void display(){
		System.out.println("nama " + super.getNama_pembeli());
        System.out.println("no telp = " + super.getNo_telepon());
        System.out.println("frame = " + super.getFrame());
        System.out.println("minus kanan = " + this.minus_mata_kanan);
        System.out.println("minus kiri = " + this.minus_mata_kiri);
	}
}
